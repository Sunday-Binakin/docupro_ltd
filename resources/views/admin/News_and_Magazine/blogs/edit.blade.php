            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <br>
                        <form method="POST" action="{{ route('blog.update',$edit_story->id) }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Title</label>
                                <div class="col-sm-12">
                                    <input class="form-control " type="text" name="title" value="{{ $edit_story->title }}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-12">
                                    <input class="form-control " type="text" name="story_by"
                                        value="{{ $edit_story->story_by }}" id="example-text-input">
                                    <br>
                                    @error('')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-12">
                                    {{-- <input class="form-control " type="text" name="about" 
                                        id="example-text-input"> --}}
                                    <textarea name="story_summary" id="story_summary">{{ $edit_story->story_summary }}</textarea>
                                    <br>
                                    @error('story_summary')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-12">
                                    {{-- <input class="form-control " type="text" name="about" 
                                        id="example-text-input"> --}}
                                    <textarea name="story_body" id="story_body">{{ $edit_story->story_body }}</textarea>
                                    <br>
                                    @error('story_body')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-12">
                                    <img id="showImage" class="rounded avatar-lg"
                                        src="{{ asset($edit_story->cover_image) }}" alt="Card image cap">
                                </div>
                                <br>
