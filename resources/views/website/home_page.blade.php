...
@section('page-content')
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="image-layer"
                        style="background-image: url({{ asset('website/assets/images/backgrounds/main-slider-1-1.jpg') }});"></div>
                    <!-- /.image-layer -->

                    <div class="main-slider-shape-1 float-bob-x">
                        <img src="{{ asset('website/') }}assets/images/shapes/main-slider-shape-1.png" alt="">
                    </div>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="main-slider__content">
                                    <h2 class="main-slider__title">Insurance <br> for the better <br> family <span>life.</span></h2>
                                    <p class="main-slider__text">Phasellus condimentum laoreet turpis, ut tincid sodales <br> in. Integer leo arcu, mollis sit amet tempor.</p>
                ...
                <div class="swiper-slide">
                    <div class="image-layer"
                        style="background-image: url({{ asset('website/assets/images/backgrounds/main-slider-1-2.jpg') }});"></div>
                    <!-- /.image-layer -->
                ...
                <div class="swiper-slide">
                    <div class="image-layer"
                        style="background-image: url({{ asset('website/assets/images/backgrounds/main-slider-1-3.jpg') }});"></div>
                    <!-- /.image-layer -->
                        ...
                        <div class="feature-one__single">
                            <div class="feature-one__single-inner">
                                ...
                                <div class="feature-one__shape">
                                    <img src="{{ asset('website/assets/images/shapes/feature-one-shape-1.png') }}" alt="">
                                </div>
    ...
    <section class="about-one">
        ...
        data-wow-duration="2500ms" style="background-image: url({{ asset('website/assets/images/backgrounds/about-one-bg.png;"></') }}div>
        <div class="container">
            <div class="row">
                <div class="col-xl-6">
                    <div class="about-one__left">
                        ...
                        data-wow-duration="2500ms">
                            <div class="about-one__img">
                                <img src="{{ asset('website/assets/images/resources/about-one-img-1.jpg') }}" alt="">
                            </div>
                            <div class="about-one__img-two">
                                <img src="{{ asset('website/assets/images/resources/about-one-img-2.jpg') }}" alt="">
                            </div>
                            ...
                            <div class="about-one__shape-1">
                                <img src="{{ asset('website/assets/images/shapes/about-one-shape-1.jpg') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="section-title text-left">
                            <div class="section-sub-title-box">
                                ...
                                <div class="section-title-shape-1">
                                    <img src="{{ asset('website/assets/images/shapes/section-title-shape-1.png') }}" alt="">
                                </div>
                                <div class="section-title-shape-2">
                                    <img src="{{ asset('website/assets/images/shapes/section-title-shape-2.png') }}" alt="">
                                </div>
                            </div>
                            <h2 class="section-title__title">We provide the best insurance policy</h2>
                        </div>
                        <p class="about-one__text-1">Duis aute irure dolor in reprehenderit in velit esse cillum dolore eu nulla pariatur.</p>
            ...
            <div class="services-one__container">
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="services-one__single">
                            <div class="service-one__img">
                                <img src="{{ asset('website/assets/images/services/services-1-1.jpg') }}" alt="">
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="services-one__single">
                            <div class="service-one__img">
                                <img src="{{ asset('website/assets/images/services/services-1-2.jpg') }}" alt="">
                            </div>
                            <div class="service-one__content">
                                <div class="services-one__icon">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                        <div class="services-one__single">
                            <div class="service-one__img">
                                <img src="{{ asset('website/assets/images/services/services-1-3.jpg') }}" alt="">
                            </div>
                            <div class="service-one__content">
                                <div class="services-one__icon">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                        <div class="services-one__single">
                            <div class="service-one__img">
                                <img src="{{ asset('website/assets/images/services/services-1-4.jpg') }}" alt="">
                            </div>
                            <div class="service-one__content">
                                <div class="services-one__icon">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="500ms">
                        <div class="services-one__single">
                            <div class="service-one__img">
                                <img src="{{ asset('website/assets/images/services/services-1-5.jpg') }}" alt="">
                            </div>
                            <div class="service-one__content">
                                <div class="services-one__icon">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="600ms">
                        <div class="services-one__single">
                            <div class="service-one__img">
                                <img src="{{ asset('website/assets/images/services/services-1-6.jpg') }}" alt="">
                            </div>
                            <div class="service-one__content">
                                <div class="services-one__icon">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="700ms">
                        <div class="services-one__single">
                            <div class="service-one__img">
                                <img src="{{ asset('website/assets/images/services/services-1-7.jpg') }}" alt="">
                            </div>
                            <div class="service-one__content">
                                <div class="services-one__icon">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="800ms">
                        <div class="services-one__single">
                            <div class="service-one__img">
                                <img src="{{ asset('website/assets/images/services/services-1-8.jpg') }}" alt="">
                            </div>
                            <div class="service-one__content">
                                <div class="services-one__icon">
    ...
    <section class="why-choose-one">
        <div class="why-choose-one-shape-1" style="background-image: url({{ asset('website/assets/images/shapes/why-choose-one-shape-1.png;') }});"></div>
        <div class="why-choose-one-shape-2 float-bob-y">
            <img src="{{ asset('website/assets/images/shapes/why-choose-one-shape-2.png') }}" alt="">
        </div>
        <div class="why-choose-one-shape-3 float-bob-x">
            <img src="{{ asset('website/assets/images/shapes/why-choose-one-shape-3.png') }}" alt="">
        </div>
        <div class="why-choose-one-shape-4 float-bob-y">
            <img src="{{ asset('website/assets/images/shapes/why-choose-one-shape-4.png') }}" alt="">
        </div>
        <div class="why-choose-one-shape-5 float-bob-y">
            <img src="{{ asset('website/assets/images/shapes/why-choose-one-shape-5.png') }}" alt="">
        </div>
        <div class="why-choose-one-shape-6 float-bob-x">
            <img src="{{ asset('website/assets/images/shapes/why-choose-one-shape-6.png') }}" alt="">
        </div>
        <div class="why-choose-one-img wow slideInRight" data-wow-delay="100ms"
        data-wow-duration="2500ms">
            <img src="{{ asset('website/assets/images/resources/why-choose-one-img.png') }}" alt="">
        </div>
        <div class="container">
            <div class="row">
                    ...
                    <div class="why-choose-one__left">
                        <div class="section-title text-left">
                            <div class="section-sub-title-box">
                                ...
                                <div class="section-title-shape-1">
                                    <img src="{{ asset('website/assets/images/shapes/section-title-shape-3.png') }}" alt="">
                                </div>
                                <div class="section-title-shape-2">
                                    <img src="{{ asset('website/assets/images/shapes/section-title-shape-4.png') }}" alt="">
                                </div>
                            </div>
                            <h2 class="section-title__title">Few reasons for people choosing insur</h2>
                        </div>
                        <p class="why-choose-one__text">Nullam eu nibh vitae est tempor molestie id sed ex. Quisque dignissim maximus ipsum, sed rutrum metus tincidunt et.</p>
                                    ...
                                    <div class="why-choose-one__single">
                                        ...
                                        <div class="why-choose-one__list-title-box">
                                            ...
                                            <div class="why-choose-one__list-text-box">
                                                <p class="why-choose-one__list-text">Lorem ipsum dolor sit amet, sectetur adipiscing elit.</p>
                                            </div>
                                        </div>
                                    </div>
                                </li>
            ...
            <div class="row">
                <div class="col-xl-6">
                    <div class="get-insurance__left">
                        ...
                        data-wow-duration="2500ms">
                            <img src="{{ asset('website/assets/images/resources/get-insurance-img-1.png')}}"alt="">
                        </div>
                        ...
                        <div class="get-insurance__shape-1 float-bob-x">
                            <img src="{{ asset('website/assets/images/shapes/get-insurance-shape-1.png') }}" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-xl-6">
    ...
    <Section class="counter-one">
        <div class="counter-one-shape-1 float-bob-y">
            <img src="{{ asset('website/assets/images/shapes/counter-one-shape-1.png') }}" alt="">
        </div>
        <div class="counter-one-shape-2 float-bob-y">
            <img src="{{ asset('website/assets/images/shapes/counter-one-shape-2.png') }}" alt="">
        </div>
        <div class="container">
            <div class="row">
    ...
    <section class="team-one">
        <div class="team-one__shape-1 float-bob-y">
            <img src="{{ asset('website/assets/images/shapes/team-one-shape-1.png') }}" alt="">
        </div>
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="team-one__single">
                        <div class="team-one__img">
                            <div class="team-one__img-box">
                                <img src="{{ asset('website/assets/images/team/team-1-1.jpg') }}" alt="">
                            </div>
                ...
                <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                    <div class="team-one__single">
                        <div class="team-one__img">
                            <div class="team-one__img-box">
                                <img src="{{ asset('website/assets/images/team/team-1-2.jpg') }}" alt="">
                            </div>
                            <ul class="list-unstyled team-one__social">
                                <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                ...
                <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                    <div class="team-one__single">
                        <div class="team-one__img">
                            <div class="team-one__img-box">
                                <img src="{{ asset('website/assets/images/team/team-1-3.jpg') }}" alt="">
                            </div>
                            <ul class="list-unstyled team-one__social">
                                <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="#"><i class="fab fa-twitter"></i></a></li>
    ...
    <section class="testimonial-one">
        <div class="testimonial-one-shape-2 float-bob-y">
            <img src="{{ asset('website/assets/images/shapes/testimonial-one-shape-2.png') }}" alt="">
        </div>
        <div class="testimonial-one-shape-3 float-bob-y">
            <img src="{{ asset('website/assets/images/shapes/testimonial-one-shape-3.png') }}" alt="">
        </div>
        <div class="container">
                                ...
                                <div class="testimonial-one__single">
                                    <div class="testimonial-one__single-inner">
                                        <div class="testimonial-one__shape-1">
                                            <img src="{{ asset('website/assets/images/shapes/testimonial-one-shape-1.png') }}" alt="">
                                        </div>
                                        <div class="testimonial-one__client-info">
                                            <div class="testimonial-one__client-img-box">
                                                <img src="{{ asset('website/assets/images/testimonial/testimonial-1-1.jpg') }}" alt="">
                                                <div class="testimonial-one__quote">
                                                    <img src="{{ asset('website/assets/images/testimonial/testimonial-1-quote.png') }}" alt="">
                                                </div>
                                            </div>
                            ...
                            <div class="item">
                                <div class="testimonial-one__single">
                                    <div class="testimonial-one__single-inner">
                                        ...
                                        <div class="testimonial-one__client-info">
                                            <div class="testimonial-one__client-img-box">
                                                <img src="{{ asset('website/assets/images/testimonial/testimonial-1-2.jpg') }}" alt="">
                                                <div class="testimonial-one__quote">
                                                    <img src="{{ asset('website/assets/images/testimonial/testimonial-1-quote.png') }}" alt="">
                                                </div>
                                            </div>
                            ...
                            <div class="item">
                                <div class="testimonial-one__single">
                                    <div class="testimonial-one__single-inner">
                                        ...
                                        <div class="testimonial-one__client-info">
                                            <div class="testimonial-one__client-img-box">
                                                <img src="{{ asset('website/assets/images/testimonial/testimonial-1-3.jpg') }}" alt="">
                                                <div class="testimonial-one__quote">
                                                    <img src="{{ asset('website/assets/images/testimonial/testimonial-1-quote.png') }}" alt="">
                                                </div>
                                            </div>
                            ...
                            <div class="item">
                                <div class="testimonial-one__single">
                                    <div class="testimonial-one__single-inner">
                                        ...
                                        <div class="testimonial-one__client-info">
                                            <div class="testimonial-one__client-img-box">
                                                <img src="{{ asset('website/assets/images/testimonial/testimonial-1-4.jpg') }}" alt="">
                                                <div class="testimonial-one__quote">
                                                    <img src="{{ asset('website/assets/images/testimonial/testimonial-1-quote.png') }}" alt="">
                                                </div>
                                            </div>
        ...
        <div class="container">
            <div class="tracking__inner">
                <div class="tracking-shape-1 float-bob-y">
                    <img src="{{ asset('website/assets/images/shapes/tracking-shape-1.png') }}" alt="">
                </div>
                <div class="tracking-shape-2 float-bob-x">
                    <img src="{{ asset('website/assets/images/shapes/tracking-shape-2.png') }}" alt="">
                </div>
                <div class="tracking-shape-3 float-bob-x">
                    <img src="{{ asset('website/assets/images/shapes/tracking-shape-3.png') }}" alt="">
                </div>
