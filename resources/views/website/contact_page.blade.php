                    ...
                    <div class="section-title text-left">
                        <div class="section-sub-title-box">
                            ...
                            <div class="section-title-shape-1">
                                <img src="{{ asset('website/assets/images/shapes/section-title-shape-1.p') }}" alt="">
                            </div>
                            <div class="section-title-shape-2">
                                <img src="{{ asset('website/assets/images/shapes/section-title-shape-2.p') }}" alt="">
                            </div>
                        </div>
            ...
            <div class="col-xl-8 col-lg-7">
                <div class="contact-page__right">
                    <div class="contact-page__form">
                        <form action="https://layerdrops.com/insur/main-html/assets/inc/sendemail.php" class="comment-one'form contact-form-validated" novalidate="novalidate">
                            <div class="row">
                                <div class="col-xl-6">
