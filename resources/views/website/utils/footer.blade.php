<footer class="site-footer">
    <div class="site-footer-bg" style="background-image: url({{ asset('website/assets/images/backgrounds/site-footer-bg.png') }});"></div>
    <div class="container">
                        ...
                        <ul class="footer-widget__gallery-list list-unstyled clearfix">
                            <li>
                                <div class="footer-widget__gallery-img">
                                    <img src="{{ asset('website/assets/images/resources/footer-widget-gallery-img-1.jpg') }}" alt="">
                                    <a href="#"><span class="fa fa-link"></span></a>
                                </div>
                            </li>
                            <li>
                                <div class="footer-widget__gallery-img">
                                    <img src="{{ asset('website/assets/images/resources/footer-widget-gallery-img-2.jpg') }}" alt="">
                                    <a href="#"><span class="fa fa-link"></span></a>
                                </div>
                            </li>
                            <li>
                                <div class="footer-widget__gallery-img">
                                    <img src="{{ asset('website/assets/images/resources/footer-widget-gallery-img-3.jpg') }}" alt="">
                                    <a href="#"><span class="fa fa-link"></span></a>
                                </div>
                            </li>
                            <li>
                                <div class="footer-widget__gallery-img">
                                    <img src="{{ asset('website/assets/images/resources/footer-widget-gallery-img-4.jpg') }}" alt="">
                                    <a href="#"><span class="fa fa-link"></span></a>
                                </div>
                            </li>
                            <li>
                                <div class="footer-widget__gallery-img">
                                    <img src="{{ asset('website/assets/images/resources/footer-widget-gallery-img-5.jpg') }}" alt="">
                                    <a href="#"><span class="fa fa-link"></span></a>
                                </div>
                            </li>
                            <li>
                                <div class="footer-widget__gallery-img">
                                    <img src="{{ asset('website/assets/images/resources/footer-widget-gallery-img-6.jpg') }}" alt="">
                                    <a href="#"><span class="fa fa-link"></span></a>
                                </div>
                            </li>
                        </ul>
