                ...
                <div class="about-four__left">
                    <div class="about-four__img-box wow slideInLeft" data-wow-delay="100ms" data-wow-duration="2500ms">
                        <div class="about-four__img">
                            <img src="{{ asset('website/assets/images/resources/about-four-img-1.jpg') }}" alt="">
                        </div>
                        <div class="about-four__img-two">
                            <img src="{{ asset('website/assets/images/resources/about-four-img-2.jpg') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="about-four__right">
                    ...
                    <div class="about-four__founder">
                        <div class="about-four__founder-img">
                            <img src="{{ asset('website/assets/images/resources/about-four-founder-img.jpg') }}" alt="">
                        </div>
                    ...
                    <div class="thm-swiper__slider swiper-container" data-swiper-options='{"spaceBetween": 100, "slidesPerView": 5, "autoplay": { "delay": 5000 }, "breakpoints": {
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="{{ asset('website/assets/images/brand/brand-1-1.png') }}" alt="">
                            </div><!-- /.swiper-slide -->
                            <div class="swiper-slide">
                                <img src="{{ asset('website/assets/images/brand/brand-1-2.png') }}" alt="">
                            </div><!-- /.swiper-slide -->
                            <div class="swiper-slide">
                                <img src="{{ asset('website/assets/images/brand/brand-1-3.png') }}" alt="">
                            </div><!-- /.swiper-slide -->
                            <div class="swiper-slide">
                                <img src="{{ asset('website/assets/images/brand/brand-1-4.png') }}" alt="">
                            </div><!-- /.swiper-slide -->
                            <div class="swiper-slide">
                                <img src="{{ asset('website/assets/images/brand/brand-1-5.png') }}" alt="">
                            </div><!-- /.swiper-slide -->
                            <div class="swiper-slide">
                                <img src="{{ asset('website/assets/images/brand/brand-1-1.png') }}" alt="">
                            </div><!-- /.swiper-slide -->
...
<section class="testimonial-two">
    <div class="testimonial-two-shape-1"
        style="background-image: url({{ asset('website/assets/images/shapes/testimonial-two-shape-1.png') }});"></div>
    <div class="container">
        <div class="row">
            <div class="col-xl-6">
                        ...
                        <div class="testimonial-two__wrap">
                            <div class="testimonial-two__single">
                                <div class="testimonial-two__single-inner">
                                    <div class="testimonial-two-shape-2">
                                        <img src="{{ asset('website/assets/images/shapes/testimonial-two-shape-2.png') }}" alt="">
                                    </div>
                                ...
                                <div class="testimonial-two__founder-box">
                                    <div class="testimonial-two__founder">
                                        ...
                                        <div class="testimonial-two__founder-shape">
                                            <img src="{{ asset('website/assets/images/shapes/testimonial-two-founder-shape.png') }}" alt="">
                                        </div>
                                    </div>
                                    <div class="testimonial-two__client-img-box">
                                        <div class="testimonial-two__client-img">
                                            <img src="{{ asset('website/assets/images/testimonial/testimonial-3-1.jpg') }}" alt="">
                                        </div>
                            ...
                            <div class="testimonial-two__single">
                                ...
                                <div class="testimonial-two__founder-box">
                                    ...
                                    <div class="testimonial-two__client-img-box">
                                        <div class="testimonial-two__client-img">
                                            <img src="{{ asset('website/assets/images/testimonial/testimonial-3-2.jpg') }}" alt="">
                                        </div>
                                        <div class="testimonial-two__quote">
                                            <img src="{{ asset('website/assets/images/testimonial/testimonial-1-quote.png') }}" alt="">
                                        </div>
                        ...
                        <div class="testimonial-two__wrap">
                            <div class="testimonial-two__single">
                                ...
                                <div class="testimonial-two__founder-box">
                                    ...
                                    <div class="testimonial-two__client-img-box">
                                        <div class="testimonial-two__client-img">
                                            <img src="{{ asset('website/assets/images/testimonial/testimonial-3-3.jpg') }}" alt="">
                                        </div>
                                        <div class="testimonial-two__quote">
                                            <img src="{{ asset('website/assets/images/testimonial/testimonial-1-quote.png') }}" alt="">
                                        </div>
                            ...
                            <div class="testimonial-two__single">
                                ...
                                <div class="testimonial-two__founder-box">
                                    ...
                                    <div class="testimonial-two__client-img-box">
                                        <div class="testimonial-two__client-img">
                                            <img src="{{ asset('website/assets/images/testimonial/testimonial-3-4.jpg') }}" alt="">
                                        </div>
                                        <div class="testimonial-two__quote">
                                            <img src="{{ asset('website/assets/images/testimonial/testimonial-1-quote.png') }}" alt="">
                                        </div>
...
<section class="cta-one cta-four">
    <div class="cta-four-shape-1 float-bob-x">
        <img src="{{ asset('website/assets/images/shapes/cta-four-shape-1.png') }}" alt="">
    </div>
    <div class="container">
        <div class="cta-one__content">
            <div class="cta-one__inner">
                ...
                <div class="cta-one__img">
                    <img src="{{ asset('website/assets/images/resources/cta-one-img.png') }}" alt="">
                </div>
            </div>
        </div>
    </div>
